...
##### Run the network using different filter sizes #####
    ...
    # Run the deep net
    conv_1, pool_1, conv_2, pool_2, logits = cnn(x, 1)
    ...
    with tf.Session() as sess:
        ...
        plt.title('Test Accuracies with Different Optimizers using Dropout.')
        ...
        plt.title('Train Errors with Different Optimizers using Dropout.')
        plt.legend(loc='lower right')
