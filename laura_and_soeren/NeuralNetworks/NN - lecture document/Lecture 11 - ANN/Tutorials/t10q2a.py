#
# Tutorial 10, Question 2a: undercomplete AE
#
...
pylab.xlabel('epochs')
pylab.ylabel('m.s.e')
pylab.savefig('figures/t10q2a_1.png')

pylab.figure()
pylab.gray()
for i in range(49):
    pylab.subplot(7, 7, i+1); pylab.axis('off'); pylab.imshow(w[:,i].reshape(10,10))
pylab.savefig('figures/t10q2a_2.png')
...
pylab.savefig('figures/t10q2a_3.png')

pylab.figure()
pylab.gray()
for i in range(100):
    pylab.subplot(10, 10, i+1); pylab.axis('off'); pylab.imshow(y_[i,:].reshape(10,10))
pylab.savefig('figures/t10q2a_4.png')

pylab.figure()
pylab.gray()
for i in range(100):
    pylab.subplot(10, 10, i+1); pylab.axis('off'); pylab.imshow(h_[i,:].reshape(7,7))
pylab.savefig('figures/t10q2a_5.png')
